...
export const JOURNAL: EntreeJournal[] = [
  {
    ...
    etapes: [
      ...
      "Chaque vente porte maintenant un bloc Taxes perçues où la TPS se calcule à 5 % sur les livres comme tu l'as demandé; si tu inscris un transport facturé, la TPS et la TVQ (9,975 %) s'y ajoutent toutes seules. Tu peux changer le pourcentage ou corriger les deux montants à la main quand ils ne collent pas à ce que tu as vraiment perçu, puis revenir au calcul d'un clic.",
      ...
      "Sous les totaux de l'année, un panneau Taxes perçues en 2026 additionne la TPS, la TVQ et le total à remettre pour toutes tes ventes en direct comme chez les dépositaires; le détail des ventes montre aussi les taxes de chaque ligne. Les ventes inscrites avant aujourd'hui n'en portent pas encore : ouvre celles où tu avais perçu des taxes et enregistre-les, le panneau se mettra à jour.",
    ],
  },
  {
    date: '2026-09-20',
