            ...
            {publishedInterviews.map((interview, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-2xl font-serif font-bold text-white mb-3 group-hover:text-gold transition-colors">{interview.title}</h3>
                  <p className="text-slate-400 text-sm leading-relaxed mb-6 line-clamp-3">{interview.description}</p>
                  {interview.mediaType === 'audio' && (
                    <div className="mt-auto"><audio controls src={interview.mediaUrl} className="w-full h-10 rounded-lg bg-white/5" /></div>
                  )}
