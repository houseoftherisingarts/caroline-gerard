...
const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-screen pt-24 md:pt-40 pb-20 w-full px-5 md:px-16 flex flex-col items-center justify-center text-center">
      <Helmet>
      ...
      >
        ...
        <motion.div
          ...
          className="bg-gold/20 p-5 rounded-full mb-6"
        >
          <QuillIcon className="text-gold w-10 h-10" />
        </motion.div>

        <h1
          className="font-serif text-7xl md:text-9xl text-gold leading-none mb-6"
          style={{ textShadow: '0 0 30px rgba(212, 175, 55, 0.25)' }}
        >
          404
        </h1>

        <p className="font-serif text-lg md:text-2xl text-white mb-6 leading-snug">
