...
const ConferencesPage = ({ conferences, setLeads }: { conferences: Conference[], setLeads: React.Dispatch<React.SetStateAction<Lead[]>> }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-32">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-serif font-bold text-white">Engager Caroline</h1>
        <p className="text-slate-400 mt-4 max-w-2xl mx-auto">Sollicitez une intervention de Caroline Gérard pour votre prochain événement, séminaire ou atelier d&apos;entreprise. Partagez un thème et discutons des possibilités.</p>
      </div>
          ...
          <div key={conference.id} className="bg-midnight/60 backdrop-blur-md rounded-xl border border-white/10 overflow-hidden flex flex-col group">
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <div className="flex gap-2 mt-auto">
                <button onClick={() => setDetailsModalOpen(conference)} className="flex-1 bg-white/10 text-white font-bold py-3 rounded-lg hover:bg-white/20 transition-colors flex items-center justify-center gap-2">
